			...
			<tr>
                ...
                <form action="" method="post" id="job_form">
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_form tableclass_full">
                        ...
                        <?php if(module_config::c('job_enable_default_tasks',1)){ ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php if((int)$job_id>0){ ?>
                                    <input type="button" name="s" id="save_saved" value="<?php _e('Save');?>" class="task_defaults small_button">
                                    <?php } ?>
                                    <input type="button" name="i" id="insert_saved" value="<?php _e('Insert');?>" class="task_defaults small_button">
                        ...
                        <?php } ?>
                            <?php if((int)$job_id>0 && module_invoice::can_i('create','Invoices')){ ?>
                            <tr>
                                <th>
                                    <?php _e('Job Deposit');?>
                                </th>
                ...
                <?php if(module_job::can_i('edit','Job Tasks')||module_job::can_i('view','Job Tasks')){ ?>
					...
					<h3>
                        ...
                        <span class="button" id="show_completed_tasks" style="display:none;">
                            <a href="#" onclick="show_completed_tasks(); return false;" class="uibutton"><?php _e('Show Completed Tasks');?></a>
                        </span>
                        <span class="button" id="hide_completed_tasks">
                            <a href="#" onclick="hide_completed_tasks(); return false;" class="uibutton"><?php _e('Hide Completed Tasks');?></a>
                        </span>
                        <?php } ?>
            ...
            <?php }  // end can i view job tasks ?>
                ...
                <div class="content_box_wheader">
                    <span id="create_invoice_button"><?php if($job['total_amount_invoicable'] > 0 && module_invoice::can_i('create','Invoices')){ ?>
                        <a class="submit_button save_button uibutton" href="<?php echo module_invoice::link_generate('new',array('arguments'=>array(
                            'job_id' => $job_id,
