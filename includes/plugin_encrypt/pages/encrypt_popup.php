...
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/json2.js');?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/jsbn.js');?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/jsbn2.js');?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/prng4.js');?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/rng.js');?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/rsa.js');?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/rsa2.js');?>"></script>
...
<table class="tableclass tableclass_form tableclass_full" id="enc_existing">
    ...
    <?php if(module_encrypt::can_i('edit','Encrypts')){ ?>
    <tr>
        <th>
        </th>
        <td>
