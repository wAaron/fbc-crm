...
$replace['total_amount'] = dollar($invoice['total_amount'],true,$invoice['currency_id']);
$replace['date_paid'] = print_date($invoice['date_paid']);
$replace['date_due'] = print_date($invoice['date_due']);
$replace['invoice_number'] = $invoice['name'];
$replace['from_name'] = module_security::get_loggedin_name();
$replace['invoice_url'] = module_invoice::link_public($invoice_id);
