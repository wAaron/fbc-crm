...
//                    $user['last_name'] = implode(' ',$name_parts);
            ...
            case 'website':
                ...
                return $user;
            case 'ticket':
                return module_ticket::get_newsletter_recipient($args['owner_id']);
            case 'member':
                return module_member::get_newsletter_recipient($args['owner_id']);
        ...
        <span>
            ...
            <span id="bulk_popdown" style="position: absolute; width: 200px; display: none; background: #EFEFEF; margin-left: -210px; margin-top: 30px; border: 1px solid #CCC; text-align: left; padding: 6px; z-index: 3;">
                ...
                <?php
                    ...
                    <input type="button" name="bulk_action_button" id="bulk_action_button" value="<?php _e('Perform Bulk Action');?>">
                    <script type="text/javascript">
                        $(function(){
